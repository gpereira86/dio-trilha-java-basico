...
public class ProcessoSeletivo {
    ...
    static void imprimirSelecionados() {
        ...
        System.out.println("Imprimindo a lista de candidatos informando i índice do elemento");
    ...
    static void selecaoCandidatos(){
        String[] candidatos = {"JOÃO", "MARIA", "PEDRO", "ANA", "CARLOS", "LUCAS", "FABIOLA", "MARCOS", "JULIA", "VITOR"};
